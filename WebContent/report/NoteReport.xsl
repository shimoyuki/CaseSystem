	...
	<xsl:template match="NoteBody">
		...
		<fo:block width="760px" margin-top="20px" height="30px"
			...
			<fo:inline border-bottom-width="1px" border-bottom-style="solid"
				border-bottom-color="black" padding-left="50px" padding-right="50px">
		...
		<fo:block width="760px" margin-top="20px" height="30px"
			...
			<fo:inline border-bottom-width="1px" border-bottom-style="solid"
				border-bottom-color="black" padding-left="130px" padding-right="130px">
		...
		<fo:block width="760px" margin-top="20px" height="30px"
			...
			<fo:inline border-bottom-width="1px" border-bottom-style="solid"
				border-bottom-color="black" padding-left="65px" padding-right="65px">
		...
		<fo:block width="760px" margin-top="20px" height="30px"
			...
			<fo:inline border-bottom-width="1px" border-bottom-style="solid"
				border-bottom-color="black" padding-left="123px" padding-right="123px">
		...
		<fo:block width="760px" margin-top="20px" height="30px"
			...
			<fo:inline border-bottom-width="1px" border-bottom-style="solid"
				border-bottom-color="black" padding-left="137px" padding-right="137px">
		...
		<fo:block width="760px" margin-top="20px" height="30px"
			...
			<fo:inline border-bottom-width="1px" border-bottom-style="solid"
				border-bottom-color="black" padding-left="200px" padding-right="200px">
		...
		<fo:block width="760px" margin-top="20px" height="30px"
			...
			<fo:inline border-bottom-width="1px" border-bottom-style="solid"
				border-bottom-color="black" color="white" padding-left="200px"
				padding-right="200px">
				<xsl:text>····</xsl:text>
			</fo:inline>
		</fo:block>
